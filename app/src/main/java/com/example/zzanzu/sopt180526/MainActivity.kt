...
import com.example.zzanzu.sopt180526.R.id.*
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        main_insert_btn.setOnClickListener {
            ...
            main_collection_rv.adapter = collectionAdapter
        }
    ...
    fun init() {
        ...
        main_collection_rv.layoutManager = LinearLayoutManager(this)
    ...
    override fun onClick(v: View?) {
        val idx : Int = main_collection_rv.getChildAdapterPosition(v)
